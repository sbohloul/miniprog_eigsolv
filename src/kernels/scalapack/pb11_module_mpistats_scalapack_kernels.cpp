...
PYBIND11_MODULE(pb11_mpistats_scalapack_kernels, m)
{
    ...
    m.doc() = "Module for collecting mpi statistics of scalapack";
    ...
    m.def("pb11_mpistats_scalapack_pdsyev", &pb11_mpistats_scalapack_pdsyev, "time pdsyev");
}