...
set(BLAS_DIR "$ENV{OPENBLASROOT}" CACHE STRING "" FORCE)
set(BLAS_LIB ${BLAS_DIR}/libopenblas.so CACHE STRING "" FORCE)
...
set(SCALAPACK_LIB ${SCALAPACK_DIR}/libscalapack.so ${BLAS_LIB} -lgfortran CACHE STRING "" FORCE)
